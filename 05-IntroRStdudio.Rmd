# Introduction to Business Analytics in R Studio {#RBusinessAnalytics}
...
Industry literature says there are four categories of customer for Analytics projects each having differing needs (see figure). 

(ref:RStudio1) The four kinds of Mass Customisation

```{r,echo=FALSE, fig.cap='(ref:RStudio1)'}
...
The IDE gives you complete control of all aspects of an Analytics project. This enables the user to meet the needs of Adaptive, Transparent and Cosmetic customers. 

(ref:RStudio2) The R Studio Interactive Development Environment.

```{r,echo=FALSE, fig.cap='(ref:RStudio2)'}
...
In R Studio you can do Reproducible Research by structuring your projects in a modular manner. (see figure) 

(ref:RStudio3) The Reproducible Research Workflow

```{r,echo=FALSE, fig.cap='(ref:RStudio3)'}
...
Read more: Mass Customization http://www.investopedia.com/terms/m/masscustomization.asp#ixzz4j1ferbtH 
