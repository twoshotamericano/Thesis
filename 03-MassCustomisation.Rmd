...
Over the next 50 pages, you will be introduced to the key components of the R Studio system and we will explore examples from Business Analytics of how the R studio is something radically new. 

But first lets get some extra motivation by exploring this Mass Customisation idea.
...
```{r,echo=FALSE, fig.cap='(ref:MassCustomisation1)'}
...
So if an important customer for a Low Cost Product desires a significantly higher quality, it can only be achieved at a large increase in cost.
...
```{r,echo=FALSE, fig.cap='(ref:MassCustomisation3)'}
...
```{r,echo=FALSE, fig.cap='(ref:MassCustomisation4)'}
